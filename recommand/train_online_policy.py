...
if __name__ == '__main__':
    ...
    init_parser.add_argument('--env_class', type=str, default='MLUserEnvironment_ListRec', help='Environment class.')
    init_parser.add_argument('--policy_class', type=str, default='SlateGFN_DB', help='Policy class')
    init_parser.add_argument('--agent_class', type=str, default='BaseOnlineAgent', help='Learning agent class')
    init_parser.add_argument('--buffer_class', type=str, default='SequentialBuffer', help='Buffer class')
