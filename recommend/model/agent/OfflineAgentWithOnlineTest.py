...
class OfflineAgentWithOnlineTest(BaseOnlineAgent):
    ...
    def action_before_train(self):
        ...
        data_loader = DataLoader(self.env.reader, batch_size=self.batch_size, shuffle=True, 
                         pin_memory=True, num_workers=8)
        # for i, data in enumerate(data_loader):
        #     print(f"Batch {i+1}:")
        #     print("Data:", data)     # 打印数据部分
        #     input()
        #     break  # 如果你只想查看一个批次的数据，可以加上 break 来跳出循环
    ...
    def step_train(self):
        ...
        # print(sample_observation);print(batch_sample);input()
        ...
        future = batch_sample['future']-1
        future[future==-1]=3043
